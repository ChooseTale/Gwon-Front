...
export function BottomSheetButton({ text }: BottomSheetButtonProps) {
  return (
    <div
...
export function BottomSheetGradientButton({ text }: BottomSheetButtonProps) {
  return (
    <div className={`${cardStyle} p-[1px] ending-gradiant-90 z-10`}>
